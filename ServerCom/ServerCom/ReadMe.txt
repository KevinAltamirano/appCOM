========================================================================
    ACTIVE TEMPLATE LIBRARY : ServerCom Project Overview
========================================================================

AppWizard has created this ServerCom project for you to use as the starting point for
...
ServerCom.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (ServerCom.h)
        GUID definitions                                (ServerCom_i.c)
        A type library                                  (ServerCom.tlb)
        Marshaling code                                 (ServerCom_p.c and dlldata.c)

ServerCom.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in ServerCom.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named ServerCom.pch and a precompiled types file named StdAfx.obj.
...
ServerComps.vcxproj
	...
	dlldata.c, ServerCom_i.c and ServerCom_p.c which are required
	to build the proxy/stub DLL.

ServerComps.vcxproj.filters
